    ...
    <>
      <div className="w-full min-h-screen">
        <div className="mt-5 text-center">
            ...
            <div className="flex flex-wrap justify-center gap-5 mt-3">
              {socials.map((contactDetail, index) => (
                <Link
                  ...
                  target="_blank"
                  className="hover:border-gray-300 duration-300 border border-white 
              hover:shadow-[0_0px_15px_-10px_rgba(0,0,0,0.3)] rounded-[15px]"
                >
                  <div className="py-5 px-6 bg-gray-100 flex items-center gap-3 rounded-[15px]">
                    <div>
                      <Image
          ...
          <div className="flex flex-warp w-full justify-center flex-wrap gap-[30px] mt-6">
